...
BASELINE_TRAJECTORIES="${BASELINE_TRAJECTORIES:-${PROJECT_DIR}/../v2_baseline/mini-swe-agent/trajectories_baseline_gpt54mini}"
REPO_ROOT="${REPO_ROOT:-${PROJECT_DIR}/repos}"
